...
<head>
    ...
    <title>SIMBA - Dashboard Manager</title> <%-- Título atualizado --%>
    ...
    <main class="main-content flex-1 p-6 sm:p-8 md:p-10 overflow-y-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="fade-in-animation delay-1 bg-white rounded-xl p-6 shadow-custom-lg border border-slate-100 flex flex-col items-start transition-all duration-200 ease-in-out hover:shadow-xl hover:-translate-y-px">
                ...
                <a href="<%= request.getContextPath() %>/dashboard/school-registries-manager" class="mt-auto">
                    <button class="text-sm font-medium text-custom-purple hover:text-custom-purple-hover hover:underline">Gerenciar agora <i class="fas fa-arrow-right ml-1"></i></button>
                </a>
            </div>
