...
public class Student extends User{
    ...
    public Student(Username username, String name, String street, int number , String neighborhood, String city, String stateAbbr, Email email, Password password, String enrollmentId) {
