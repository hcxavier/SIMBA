...
public class Teacher extends User {
    ...
    public Teacher(Username username, String name, String street, int number , String neighborhood, String city, String stateAbbr, Email email, Password password, Siape siape) {
