...
public class RegistryDAO {
    ...
    public void insert(Registry registry) {
        String sql = "INSERT INTO registries (barrier_specification, resolution_suggestion, location, barrier_status, barrier_criticality, barrier_type, barrier_identification_date, school_id, reṕorter_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
