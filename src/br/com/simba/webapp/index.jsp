...
<header>
    <nav>
        ...
        <ul>
            ...
            <li>FAQ</li>
            <li>Sobre</li>
            <li style="background-color: #7D5799; border-radius: 10px;">COMEÇAR AGORA</li>
        </ul>
    </nav>
</header>
...
<main>
    ...
    <section style="display: flex; margin-top: 5%;">
        <div>
            ...
            <div style="display: flex; gap: 2%; text-align: center; margin-top: 20%;">
                <div style="width: 40%;">
                    <p style="font-size: 10px; color: #3F88C5;">Não tem conta ainda</p>
                    <p style="background-color: #7D5799; padding: 5%; border-radius: 10px; margin-top: 5px; color: #ffffff;">
                        CADASTRE-SE GRÁTIS
                    </p>
                </div>
                <div style="width: 40%;">
                    <p style="font-size: 10px; color: #3F88C5;">Já possui uma conta?</p>
                    <p style="background-color: #3F88C5; padding: 5%; border-radius: 10px; margin-top: 5px; color: #ffffff;">
                        FAÇA LOGIN
                    </p>
                </div>
            </div>
        ...
        <div>
            <img src="assets/imagens/logoapr.png" style="width: 700px; height: 400px;">
        </div>
    </section>
    ...
    <section style="display: flex; flex-direction: column; align-items: center; width: 93%; margin-top: 70px; height: auto; position: relative; min-height: 90vh;">
        ...
        <div style="background-color: #f0f4f8; border-radius: 0 0 10px 10px; position: absolute; left: 12%; z-index: 1; display: flex; align-items: center; justify-content: center; gap: 50px; border: solid 1px; width: 80%; padding: 2%;">
            ...
            <div style="width: 50%; justify-items: flex-start; height: 500px;">
                ...
                <p style="margin-top: 100px; background-color: #3F88C5; color: #ffffff; text-align: center; width: 180px; height: 50px; line-height: 50px; border-radius: 10px;">
                    COMEÇAR AGORA
                </p>
            </div>
        </div>
